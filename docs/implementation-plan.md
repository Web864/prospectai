...
| Queue           | PostgreSQL `AnalysisJob` queue                      | Durable async jobs, retries, progress, worker separation.                            |
...
| `apps/worker`         | PostgreSQL job processors for analysis rows, crawler execution, AI calls, scoring. |
